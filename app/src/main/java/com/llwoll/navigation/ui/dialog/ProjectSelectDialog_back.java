 ...
 */
public class ProjectSelectDialog_back extends Dialog implements LabelCloudView.OnGetLabel{
    ...
    public ProjectSelectDialog_back(Context context, OnGetProject onGetProject) {
        super(context);
